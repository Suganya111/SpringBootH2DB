...
public class UserDetails {
	...
	private User user;
  /*public UserDetails(UserRequest userRequst) {
		this.address=userRequst.getAddress();
		this.dob=userRequst.getDob();
		this.gender=userRequst.getGender();
		this.phoneno=userRequst.getPhoneno();*/
	}
